...
public class frmPrincipal extends javax.swing.JFrame {
   PosicaoFormulario form = new PosicaoFormulario();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Financeiro Anual");
        ...
        jMenu5.setText("Localizar Demostrativo Financeiro");
        jMenu4.add(jMenu5);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
      InternalDiarioFinanceiroAnual  tela;
       form.abrirFormulario(tela = new InternalDiarioFinanceiroAnual(), jDesktop);
